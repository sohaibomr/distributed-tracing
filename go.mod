module github.com/sohaibomr/distributed-tracing

go 1.19

require (
	github.com/gorilla/mux v1.8.0
	go.elastic.co/apm/module/apmgorilla/v2 v2.4.2
)
...
replace github.com/sohaibomr/distributed-tracing/logger => ./logger
